...
<body>
<#assign columns={"name":{"width":"120px","cellEdit":"click"},"address":{"cssClass":"excludeIfNotEdited","template":r'<#if entity.region??><#if !Parameters.regionId??><a class="region" title="点击查看${entity.region.fullname}所有客户" href="customer?regionId=${entity.region.id}"></#if>${entity.region.fullname}<#if !Parameters.regionId??></a></#if></#if>${value!}'},"linkman":{"cellEdit":"click","width":"80px"},"phone":{"cellEdit":"click","width":"100px"},"mobile":{"cellEdit":"click","width":"100px"},"fax":{"cellEdit":"click","width":"100px"}}>
...
'>
<#assign searchButtons=r'<a href="chart/geo" target="_blank" title="按区域检索" style="line-height:30px;margin-left:2px;"><i class="icon-filter"></i></a>'/>
