...
<@button text='${action.getText(\'create\')+action.getText(\'order\')}' type='link' href='order/input?customer.id=${entity.id}' rel='richtable' windowoptions='{\'width\':\'950px\',\'reloadonclose\':false}'/>
">
