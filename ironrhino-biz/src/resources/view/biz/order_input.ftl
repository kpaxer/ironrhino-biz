...
<body>
<@s.form action="${actionBaseUrl}/save" method="post" cssClass="ajax form-horizontal reset sequential_create">
	<#if !order.new>
		...
		<table class="table table-bordered table-fixed middle">
			...
			<#list 0..size as index>
				<tr>
					...
					<td><@s.textfield theme="simple" name="order.items[${index}].price" cssClass="required double positive price zero" cssStyle="width:60px;"/></td>
