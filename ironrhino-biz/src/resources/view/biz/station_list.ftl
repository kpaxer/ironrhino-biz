...
<body>
<#assign columns={"name":{"width":"120px","cellEdit":"click"},"address":{"width":"220px","class":"excludeIfNotEdited","template":r'<#if entity.region??><a class="region" title="点击查看${entity.region.fullname}所有货运站" href="station?regionId=${entity.region.id}">${entity.region.fullname}</a></#if>${value!}'},"destination":{"width":"150px","cellEdit":"click"},"linkman":{"cellEdit":"click","width":"80px"},"phone":{"cellEdit":"click","width":"200px"},"mobile":{"cellEdit":"click","width":"200px"},"fax":{"cellEdit":"click","width":"80px"}}>
